      ...
      <section className="border-t border-border bg-muted/30 py-16">
        <div className="container">
          ...
          <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
            {/* Facebook */}
            <a href="https://www.facebook.com/tcsmtfcbwp/" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center rounded-lg border border-border bg-card p-6 shadow-card transition-all hover:shadow-elevated hover:-translate-y-1">
              ...
              <p className="mt-1 text-xs text-muted-foreground">@tcsmtfcbwp</p>
            </a>
            {/* Instagram */}
            <a href="https://www.instagram.com/thecountryschoolbwp/" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center rounded-lg border border-border bg-card p-6 shadow-card transition-all hover:shadow-elevated hover:-translate-y-1">
              <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10">
              ...
              <p className="mt-1 text-xs text-muted-foreground">@thecountryschoolbwp</p>
            </a>
            {/* YouTube */}
            <a href="https://www.youtube.com/@thecountryschoolbwp" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center rounded-lg border border-border bg-card p-6 shadow-card transition-all hover:shadow-elevated hover:-translate-y-1">
              <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10">
